...
exports.EnhancePromptService = void 0;
const msAgentStyleMcpService_1 = require("./msAgentStyleMcpService");
class EnhancePromptService {
    constructor() {
        this.mcpService = msAgentStyleMcpService_1.MsAgentStyleMcpService.getInstance();
     ...
     * 使用增强提示词服务优化八字分析提示词
     */
    async enhanceBaziPrompt(originalPrompt, context) {
     ...
     * 调用增强提示词API
     */
    async callEnhancePromptAPI(request) {
        // 这里实现调用增强提示词服务的逻辑
...
请直接开始你的专业命理分析：`;
     ...
     * 生成八字分析的特定提示词
     */
    generateBaziAnalysisPrompt(baziData, question) {
...
请直接开始你的专业命理分析：`;
     ...
     */
    generateEnhancedBaziPrompt(baziData, question) {
        // 完全模仿原生MCP服务的简单提示词
        return `你是一位专业的八字命理师。
...
exports.EnhancePromptService = EnhancePromptService;
//# sourceMappingURL=EnhancePromptService.js.map