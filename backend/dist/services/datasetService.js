...
class DatasetService {
    constructor(apiKey) {
        this.baseUrl = 'https://modelscope.cn/api/v1/datasets';
     ...
     */
    async loadDataset(datasetId, subsetName = 'default') {
        try {
            // 检查缓存
     ...
     * @param keywords 关键词
     */
    searchDataset(dataset, keywords) {
     ...
     * @param count 数量
     */
    getRandomItems(dataset, count = 1) {
