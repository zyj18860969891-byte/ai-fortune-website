...
// 专门的八字分析接口
router.post('/bazi/analyze', async (req: Request, res: Response) => {
  try {
...
router.get('/bazi/health', async (req: Request, res: Response) => {
  try {
...
// 从请求中提取出生数据
function extractBirthDataFromRequest(requestData: any): any {
