...
app.listen(PORT, '0.0.0.0', () => {
  ...
  console.log(`🔍 Health Check: https://ai-fortune-website-production.up.railway.app/health`);
  console.log(`📊 API Status: https://ai-fortune-website-production.up.railway.app/api/status`);
});